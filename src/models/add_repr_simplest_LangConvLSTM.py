...
class LangConvLSTMCell(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, env,lr):
        ...
        self.motor_representation_size = 2*n_actions
        ...
        # Motor-action
        self.fc2 = nn.Linear(self.motor_representation_size, n_motor_actions)
        # Word
        ...
        #IsDoMotoraction
        self.fc6 = nn.Linear(self.motor_representation_size, 1)
        #Motor representation
        self.fc7 = nn.Linear(self.vis_lang_representation_size, self.motor_representation_size)
    ...
    def forward(self, input_, prev_state, input_lang, prev_state_lang, env_task_list):
        ...
        ######################################
        ## Motor action
        output_motor_repr = f.relu(self.fc7(stacked_lang_vis_repr))
        
        IsDoMotorAction = f.sigmoid(self.fc6(output_motor_repr))        
        output = f.sigmoid(self.fc2(output_motor_repr))        
